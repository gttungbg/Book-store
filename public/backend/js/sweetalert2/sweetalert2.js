!function (t, e) {
    ...
    var Dn, jn = function (t) {
        ...
        hideLoading: fe, disableLoading: fe, getInput: function (t) {
            ...
            if (!t || F(t, n.hideClass.popup)) return W("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a news popup.");
            var o = {};
