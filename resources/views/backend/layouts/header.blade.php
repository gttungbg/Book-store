                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <div class="header-info">
                                <span>Hello, <strong>{{ \Illuminate\Support\Facades\Auth::guard('admin')->user()->name }}</strong></span>
                            </div>
                            <img src="{{ asset('backend/images/profile/pic1.jpg') }}" width="20" alt=""/>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ route('profile.index',['id' => \Illuminate\Support\Facades\Auth::guard('admin')->user()->id]) }}" class="dropdown-item ai-icon">
